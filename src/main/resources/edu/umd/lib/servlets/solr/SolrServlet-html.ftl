    ...
    <td class="header">
      ...
      <table style="params" summary="searching">
        ...
        <tr>
          <th>Solr: </th>
          <td>
            <input type="radio" name="solrAction" value="publish" checked /> Add
            <input type="radio" name="solrAction" value="depublish" /> Delete 
            <input type="submit" name="formAction" value="Index" />
          </td>
        </tr>
        </form>
        <#if formAction??>
